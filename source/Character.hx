	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-blockhead':
				...
				animation.addByPrefix('firstDeath', "Block dies", 24, false);
				animation.addByPrefix('deathLoop', "Block Dead Loop", 24, true);
			...
			case 'catsoup':
				...
				addOffset("singRIGHT", -6, -59);
				addOffset("singLEFT", 55, 6);
				addOffset("singDOWN", 70, -84);
